...
def get_numbers_ticket(min, max, quantity):
    if not (1 <= min <= max <= 100) or not (min <= quantity <= max):       # Перевірка валідності параметрів згідно з умовами
        return []
...
print(f"Лотерейні числа: {get_numbers_ticket(1, 100, 5)}")   # Приклад виклику функції
